...
import { defaultTransformer, isPlainObject as isPlainObject$1, isRedirect as isRedirect$1, isNotFound, createRootRoute, Outlet, ScrollRestoration, createFileRoute, lazyRouteComponent, lazyFn, useRouter, useRouterState, createMemoryHistory, ScriptOnce, isPlainArray, RouterProvider, createRouter as createRouter$2, defer as defer$1, pick, TSR_DEFERRED_PROMISE, createControlledPromise } from '@tanstack/react-router';
...
import g from 'react-dom/server';
...
const require$$0$3 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(w$1);
...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/nicktaylor/dev/streams/tanstack-router-stream","order":0,"outDir":"/Users/nicktaylor/dev/streams/tanstack-router-stream/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/nicktaylor/dev/streams/tanstack-router-stream","outDir":"/Users/nicktaylor/dev/streams/tanstack-router-stream/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/nicktaylor/dev/streams/tanstack-router-stream","base":"/","outDir":"/Users/nicktaylor/dev/streams/tanstack-router-stream/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start-server-functions-handler/dist/esm/index.js","root":"/Users/nicktaylor/dev/streams/tanstack-router-stream","outDir":"/Users/nicktaylor/dev/streams/tanstack-router-stream/.vinxi/build/server","order":3}],"server":{"preset":"node-server","experimental":{"asyncContext":true}},"root":"/Users/nicktaylor/dev/streams/tanstack-router-stream"};
				const buildManifest = {"client":{"_client-CLAt3_ML.js":{"file":"assets/client-CLAt3_ML.js","name":"client","dynamicImports":["app/routes/about.tsx?tsr-split","app/routes/index.tsx?tsr-split","app/routes/index.tsx?tsr-split"]},"_link-1ruuuCHp.js":{"file":"assets/link-1ruuuCHp.js","name":"link","imports":["_client-CLAt3_ML.js"]},"app/routes/about.tsx?tsr-split":{"file":"assets/about-BbJYqyPz.js","name":"about","src":"app/routes/about.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-CLAt3_ML.js","_link-1ruuuCHp.js"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-DdFMifHK.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-CLAt3_ML.js","_link-1ruuuCHp.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-AHpGHDIg.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-CLAt3_ML.js"]}},"ssr":{"_ssr-BnSvopOy.js":{"file":"assets/ssr-BnSvopOy.js","name":"ssr","dynamicImports":["app/routes/about.tsx?tsr-split","app/routes/index.tsx?tsr-split","app/routes/index.tsx?tsr-split"]},"app/routes/about.tsx?tsr-split":{"file":"assets/about-k5f1LpgT.js","name":"about","src":"app/routes/about.tsx?tsr-split","isDynamicEntry":true},"app/routes/index.tsx?tsr-split":{"file":"assets/index-XXg7Jf5j.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_ssr-BnSvopOy.js"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-BnSvopOy.js"]}},"server":{"app/routes/index.tsx?tsr-split=&tsr-directive-use-server=":{"file":"assets/index-CwdCRWfl.js","name":"index","src":"app/routes/index.tsx?tsr-split=&tsr-directive-use-server=","isDynamicEntry":true},"virtual:$vinxi/handler/server":{"file":"server.js","name":"server","src":"virtual:$vinxi/handler/server","isEntry":true,"dynamicImports":["app/routes/index.tsx?tsr-split=&tsr-directive-use-server=","app/routes/index.tsx?tsr-split=&tsr-directive-use-server="]}}};
...
const assets$1 = {
  "/_build/.vite/manifest.json": {
    ...
    "etag": "\"45d-FEqUCsGAnglxFBvG1hlfepVPY1M\"",
    "mtime": "2025-01-22T18:49:22.797Z",
    "size": 1117,
    "path": "../public/_build/.vite/manifest.json"
  },
  "/_build/assets/about-BbJYqyPz.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"177-7W8LbU4PWAHeibRuZQeORcMEHG8\"",
    "mtime": "2025-01-22T18:49:22.797Z",
    "size": 375,
    "path": "../public/_build/assets/about-BbJYqyPz.js"
  },
  "/_build/assets/client-AHpGHDIg.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3f-afOSYp1mGKqs0jRuLRVtr9jOs6Q\"",
    "mtime": "2025-01-22T18:49:22.797Z",
    "size": 63,
    "path": "../public/_build/assets/client-AHpGHDIg.js"
  },
  "/_build/assets/client-CLAt3_ML.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3e96f-gLeIChV6V4gl0UN0D1sc7AfykFI\"",
    "mtime": "2025-01-22T18:49:22.798Z",
    "size": 256367,
    "path": "../public/_build/assets/client-CLAt3_ML.js"
  },
  "/_build/assets/index-DdFMifHK.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1350-eBtqFgwV11Dv1H0IwEt7TeP3FYE\"",
    "mtime": "2025-01-22T18:49:22.797Z",
    "size": 4944,
    "path": "../public/_build/assets/index-DdFMifHK.js"
  },
  "/_build/assets/link-1ruuuCHp.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"ddb-j72XJBGzcPFYoCaSmdbe23a35YU\"",
    "mtime": "2025-01-22T18:49:22.797Z",
    "size": 3547,
    "path": "../public/_build/assets/link-1ruuuCHp.js"
  }
};
...
const _KAR9kh = eventHandler((event) => {
...
function M$1(e) {
  let t;
  const s = x(e), n = { duplex: "half", method: e.method, headers: e.headers };
...
function P(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: M$1(e), url: x(e) }, e.web.request;
}
function O() {
  return C$1();
}
...
function d(e) {
  return function(...t) {
    var s;
    let n = t[0];
    if ($(n)) t[0] = n instanceof H3Event || n.__is_event__ ? n : n[S];
    else {
      ...
      if (n = O(), !n) throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");
      t.unshift(n);
    }
    return e(...t);
  };
}
const x = d(getRequestURL), W = d(getResponseStatus), I = d(getRequestWebStream);
function U() {
  var e;
...
const j$1 = { "app_routes_index_tsx--getCount_createServerFn_handler": { functionName: "getCount_createServerFn_handler", importer: () => import('../build/index-CwdCRWfl.mjs') }, "app_routes_index_tsx--updateCount_createServerFn_handler": { functionName: "updateCount_createServerFn_handler", importer: () => import('../build/index-CwdCRWfl.mjs') } }, V = eventHandler(D$1), c = j$1;
async function D$1(e) {
  const t = P(e);
  return B$1(t);
}
function J(e) {
...
async function B$1(e, t) {
  const s = e.method, n = new URL(e.url, "http://localhost:3000"), T = new RegExp(`${J("/_server")}/([^/?#]+)`), h = n.pathname.match(T), a = h ? h[1] : null, m = Object.fromEntries(n.searchParams.entries());
  if (typeof a != "string") throw new Error("Invalid server action param for serverFnId: " + a);
  const f = c[a];
  if (!f) throw console.log("serverFnManifest", c), new Error("Server function info not found for " + a);
  let i;
  if (i = await f.importer(), !i) throw console.log("serverFnManifest", c), new Error("Server function module not resolved for " + a);
  const v = i[f.functionName];
  if (!v) throw console.log("serverFnManifest", c), console.log("fnModule", i), new Error(`Server function module export not resolved for serverFn ID: ${a}`);
  const l = await (async () => {
    try {
      const r = await (async () => {
        var g;
        if ((g = e.headers.get("Content-Type")) != null && g.includes("multipart/form-data")) return E(s.toLowerCase() !== "get", "GET requests with FormData payloads are not supported"), await e.formData();
        if (s.toLowerCase() === "get") return m.payload ? defaultTransformer.parse(m.payload) : void 0;
        const b = await e.text();
        return defaultTransformer.parse(b);
      })(), o = await v(r);
      return o instanceof Response ? o : isPlainObject$1(o) && "result" in o && o.result instanceof Response ? o.result : isRedirect$1(o) || isNotFound(o) ? R(o) : new Response(o !== void 0 ? defaultTransformer.stringify(o) : void 0, { status: W(C$1()), headers: { "Content-Type": "application/json" } });
    } catch (r) {
      return r instanceof Response ? r : isPlainObject$1(r) && "result" in r && r.result instanceof Response ? r.result : isRedirect$1(r) || isNotFound(r) ? R(r) : (console.error("Server Fn Error!"), console.error(r), console.info(), new Response(defaultTransformer.stringify(r), { status: 500, headers: { "Content-Type": "application/json" } }));
    }
  })();
  if (l.headers.get("Content-Type") === "application/json") {
    const o = await l.clone().text();
    o && JSON.stringify(JSON.parse(o));
  }
  return l;
}
function R(e) {
...
const se = `const __TSR__={matches:[],streamedValues:{},queue:[],runQueue:()=>{let e=!1;__TSR__.queue=__TSR__.queue.filter(r=>r()?(e=!0,!1):!0),e&&__TSR__.runQueue()},initMatch:e=>{__TSR__.queue.push(()=>(__TSR__.matches[e.index]||(__TSR__.matches[e.index]=e,Object.entries(e.extracted).forEach(([r,t])=>{if(t.type==="stream"){let a;t.value=new ReadableStream({start(o){a={enqueue:l=>{try{o.enqueue(l)}catch{}},close:()=>{try{o.close()}catch{}}}}}),t.value.controller=a}else if(t.type==="promise"){let a,o;t.value=new Promise((l,u)=>{o=u,a=l}),t.value.reject=o,t.value.resolve=a}})),!0)),__TSR__.runQueue()},resolvePromise:e=>{__TSR__.queue.push(()=>{const r=__TSR__.matches[e.matchIndex];if(r){const t=r.extracted[e.id];if(t&&t.type==="promise"&&t.value&&e.promiseState.status==="success")return t.value.resolve(e.promiseState.data),!0}return!1}),__TSR__.runQueue()},cleanScripts:()=>{document.querySelectorAll(".tsr-once").forEach(e=>{e.remove()})}};window.__TSR__=__TSR__;
`, oe = () => {
  const e = useRouter(), t = useRouterState({ select: (s) => s.matches.map((a) => a.meta).filter(Boolean) }), r = y.useMemo(() => {
    const s = [], a = {};
    let i;
    ...
    return s.matches.map((i) => e.looseRoutesById[i.routeId]).forEach((i) => {
      var u, l, d;
      return (d = (l = (u = e.manifest) == null ? undefined : u.routes[i.id]) == null ? undefined : l.preloads) == null ? undefined : d.filter(Boolean).forEach((m) => {
        a.push({ tag: "link", attrs: { rel: "modulepreload", href: m } });
      });
    }), a;
  }, structuralSharing: true });
  return ce([...r, ...o, ...n], (s) => JSON.stringify(s));
}, ae = () => {
  const e = useRouter(), t = oe(), r = y.useContext(Context.get("TanStackRouterHydrationContext", {}));
  return jsxs(Fragment, { children: [t.map((n, o) => createElement(D, { ...n, key: `tsr-meta-${JSON.stringify(n)}` })), jsxs(Fragment, { children: [jsx(ScriptOnce, { log: false, children: se }), jsx(ScriptOnce, { children: `__TSR__.dehydrated = ${R$1(e.options.transformer.stringify(r), { isScriptContext: true, wrap: true, json: true })}` })] })] });
}, ie = () => jsx(Fragment, { children: ae() });
function ce(e, t) {
...
const ue = () => {
  const e = useRouter(), t = useRouterState({ select: (o) => {
    ...
    return o.matches.map((a) => e.looseRoutesById[a.routeId]).forEach((a) => {
      var i, u, l;
      return (l = (u = (i = e.manifest) == null ? undefined : i.routes[a.id]) == null ? undefined : u.assets) == null ? undefined : l.filter((d) => d.tag === "script").forEach((d) => {
  ...
  return jsx(Fragment, { children: n.map((o, s) => createElement(D, { ...o, key: `tsr-scripts-${o.tag}-${s}` })) });
};
function le(e, t, r) {
  ...
  return w(t, (s, a) => {
    const i = s instanceof ReadableStream ? "stream" : s instanceof Promise ? "promise" : undefined;
    if (i === "stream") {
      const [u, l] = s.tee(), d = { dataType: e, type: i, path: a, id: n.length, matchIndex: r.match.index, streamState: he({ stream: l }) };
      return n.push(d), u;
    } else if (i === "promise") {
      const u = defer$1(s), l = { dataType: e, type: i, path: a, id: n.length, matchIndex: r.match.index, promise: u };
      n.push(l);
    }
    return s;
  });
...
function de(e) {
  ...
  const n = r.extracted, [o, s] = ["__beforeLoadContext", "loaderData"].map((a) => n ? n.reduce((i, u) => u.dataType !== a ? b(i, ["temp", ...u.path], undefined) : i, { temp: r[a] }).temp : r[a]);
  if (o !== undefined || s !== undefined || (n == null ? undefined : n.length)) {
    const a = `__TSR__.initMatch(${R$1({ index: e.matchIndex, __beforeLoadContext: t.options.transformer.stringify(o), loaderData: t.options.transformer.stringify(s), extracted: n ? Object.fromEntries(n.map((i) => [i.id, pick(i, ["type", "path"])])) : {} }, { isScriptContext: true, wrap: true, json: true })})`;
    return jsxs(Fragment, { children: [jsx(ScriptOnce, { children: a }), n ? n.map((i) => i.type === "stream" ? jsx(pe, { entry: i }, i.id) : jsx(me, { entry: i }, i.id)) : null] });
  }
  return null;
}
function w(e, t, r = []) {
  if (isPlainArray(e)) return e.map((o, s) => w(o, t, [...r, `${s}`]));
  if (isPlainObject$1(e)) {
    const o = {};
    for (const s in e) o[s] = w(e[s], t, [...r, s]);
    return o;
  }
  const n = t(e, r);
  return n !== e ? n : e;
...
function me({ entry: e }) {
  return jsx("div", { className: "tsr-once", children: jsx(y.Suspense, { fallback: null, children: jsx(fe, { entry: e }) }) });
}
function fe({ entry: e }) {
  const t = useRouter();
  if (e.promise[TSR_DEFERRED_PROMISE].status === "pending") throw e.promise;
  const r = `__TSR__.resolvePromise(${R$1({ id: e.id, matchIndex: e.matchIndex, promiseState: e.promise[TSR_DEFERRED_PROMISE] }, { isScriptContext: true, wrap: true, json: true })})`;
  return t.injectScript(r), jsx(Fragment, {});
}
function pe({ entry: e }) {
  E(e.streamState, "StreamState should be defined");
  const t = useRouter();
  return jsx(L, { streamState: e.streamState, children: (r) => {
    const n = r ? `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.enqueue(new TextEncoder().encode(${R$1(r.toString(), { isScriptContext: true, wrap: true, json: true })}))` : `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.close()`;
...
function L({ streamState: e, children: t, __index: r = 0 }) {
  const n = e.promises[r];
  if (!n) return null;
  if (n.status === "pending") throw n;
  const o = n.value;
  return jsxs(Fragment, { children: [t(o), jsx("div", { className: "tsr-once", children: jsx(y.Suspense, { fallback: null, children: jsx(L, { streamState: e, __index: r + 1, children: t }) }) })] });
}
function b(e, t, r) {
  if (t.length === 0) return r;
  const [n, ...o] = t;
  return Array.isArray(e) ? e.map((s, a) => a === Number(n) ? b(s, o, r) : s) : isPlainObject$1(e) ? { ...e, [n]: b(e[n], o, r) } : e;
}
function C(e) {
  e.router.AfterEachMatch = de, e.router.serializer = (n) => R$1(n, { isScriptContext: true, wrap: true, json: true });
  const t = Context.get("TanStackRouterHydrationContext", {}), r = y.useMemo(() => {
    var n, o;
...
function _e({ createRouter: e, getRouterManifest: t }) {
  return (r) => eventHandler(async (n) => {
    const o = toWebRequest(n), s = new URL(o.url), a = s.href.replace(s.origin, ""), i = createMemoryHistory({ initialEntries: [a] }), u = e();
    u.serializeLoaderData = le, t && (u.manifest = t()), u.update({ history: i }), await u.load();
    const l = Se({ event: n, router: u });
    return await r({ request: o, router: u, responseHeaders: l });
  });
}
function Se(e) {
  e.event.__tsrHeadersSent = true;
  let t = M(getResponseHeaders(e.event), { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((n) => n.headers));
...
const ge = /(<body)/, xe = /(<\/body>)/, Te = /(<\/html>)/, we = /(<\/[a-zA-Z][\w:.-]*?>)/g, be = new TextDecoder();
function j(e) {
  let t = false, r = "", n = "";
  return { async transform(o, s) {
    const a = r + be.decode(o), i = a.match(ge), u = a.match(xe), l = a.match(Te);
    try {
      if (i && (t = true), !t) {
        s(a), r = "";
        return;
      ...
      if (u && l && u.index < l.index) {
        ...
        let m, p = 0;
        for (; (m = we.exec(a)) !== null; ) p = m.index + m[0].length;
        if (p > 0) {
...
const ve = async ({ request: e, router: t, responseHeaders: r }) => {
  if (typeof g.renderToReadableStream == "function") {
    const n = await g.renderToReadableStream(jsx(C, { router: t }), { signal: e.signal });
    isbot(e.headers.get("User-Agent")) && await n.allReady;
    const s = [Re(t)].reduce((a, i) => a.pipeThrough(i), n);
    return new Response(s, { status: t.state.statusCode, headers: r });
  }
  if (typeof g.renderToPipeableStream == "function") {
    const n = new PassThrough();
    try {
      const a = g.renderToPipeableStream(jsx(C, { router: t }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
        a.pipe(n);
      } } : { onShellReady() {
        a.pipe(n);
      } }, onError: (i, u) => {
        console.error("Error in renderToPipeableStream:", i, u);
      } });
    } catch (a) {
      console.error("Error in renderToPipeableStream:", a);
    }
    const s = [ye(t)].reduce((a, i) => a.pipe(i), n);
    return new Response(s, { status: t.state.statusCode, headers: r });
  }
  throw new Error("No renderToReadableStream or renderToPipeableStream found in react-dom/server. Ensure you are using a version of react-dom that supports streaming.");
}, He = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/", "/about"], preloads: ["/_build/assets/client-AHpGHDIg.js", "/_build/assets/client-CLAt3_ML.js"] }, "/": { filePath: "index.tsx" }, "/about": { filePath: "about.tsx" } } });
function Ee(e) {
  return globalThis.MANIFEST[e];
}
function Me() {
  var _a;
  const e = He(), t = e.routes.__root__ = e.routes.__root__ || {};
  t.assets = t.assets || [];
  const r = Ee("client");
...
const v = createRootRoute({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "TanStack Start Starter" }] }), component: Ie });
function Ie() {
  return jsx(Pe, { children: jsx(Outlet, {}) });
}
function Pe({ children: e }) {
  return jsxs("html", { children: [jsx("head", { children: jsx(ie, {}) }), jsxs("body", { children: [e, jsx(ScrollRestoration, {}), jsx(ue, {})] })] });
}
const ke = () => import('../build/about-k5f1LpgT.mjs'), q = createFileRoute("/about")({ component: lazyRouteComponent(ke, "component", () => q.ssr) }), $e = () => import('../build/index-XXg7Jf5j.mjs'), Ae = () => import('../build/index-XXg7Jf5j.mjs'), B = createFileRoute("/")({ component: lazyRouteComponent(Ae, "component", () => B.ssr), loader: lazyFn($e, "loader") }), De = q.update({ id: "/about", path: "/about", getParentRoute: () => v }), Le = B.update({ id: "/", path: "/", getParentRoute: () => v }), je = { IndexRoute: Le, AboutRoute: De }, qe = v._addFileChildren(je)._addFileTypes();
function Be() {
  return createRouter$2({ routeTree: qe });
}
const Ke = _e({ createRouter: Be, getRouterManifest: Ce })(ve);

const handlers = [
  { route: '', handler: _KAR9kh, lazy: false, middleware: true, method: undefined },
  { route: '/_server', handler: V, lazy: false, middleware: true, method: undefined },
  { route: '/', handler: Ke, lazy: false, middleware: true, method: undefined }
];
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/nicktaylor/dev/streams/tanstack-router-stream/.data/kv"}));
...
export { B, M, nodeServer as a, node$1 as n };
